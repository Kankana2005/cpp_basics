...
void print_subsequence_whoseSum_K(int ind,vector<int>&ds,int s ,int sum,int arr[],int n){
    if(ind == n){
        if(s == sum){
...
print_subsequence_whoseSum_K(ind+1,ds,s,sum,arr,n);
...
int main(){
    ...
    int sum = 2;
    vector<int>ds;
    print_subsequence_whoseSum_K(0,ds,0,sum,arr,n);
